...
public class RoutingService {
  ...
  public RouteResult getRoute(RouteRequest routeRequest) {
    ...
    RouteResult dummyRouteResult = getRouteResult(routeRequest, polyline);

    return dummyRouteResult;
  }

  private static String getPolylineAsString(OSRDirectionsServiceGeoJSONResponse osrDirectionsServiceGeoJSONResponse) {
  ...
  private RouteResult getRouteResult(RouteRequest routeRequest, String polyline) {
    List<Charger> chargers = chargerService.getAllChargers();
