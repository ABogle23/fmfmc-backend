...
public class FoursquareRequestBuilder{
    ...
    private final String fields = "fsq_id,name,categories,closed_bucket,distance,geocodes,location,price,rating,popularity";
    ...
    public FoursquareRequest createFoursquareRequest() {
        return new FoursquareRequest(ll, radius, categories, fields, minPrice, maxPrice, openAt, openNow, neLatLong, swLatLong, limit, polygon, sortBy);
    }
}