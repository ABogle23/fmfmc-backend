...
import com.icl.fmfmc_backend.exception.GenericApiException;
  ...
  public void setUp() throws IOException, NoSuchFieldException, IllegalAccessException {
    ...
    public void getDirectionsSuccessfully() {
        mockWebServer.enqueue(new MockResponse()
                .setBody("{\"routes\":[{\"geometry\":{\"coordinates\":[[0.0,0.0],[1.0,1.0]]},\"distance\":100,\"duration\":10,\"legs\":[{\"distance\":50,\"duration\":5}]}]}")
